...
final class Version20220715124249 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Текущий список по сводке';
    }
    ...
    public function up(Schema $schema): void
    {
        $this->addSql(
            '
            CREATE TABLE current_summary_list (
        ...
        $this->addSql('COMMENT ON COLUMN current_summary_list.transfer_date IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('COMMENT ON COLUMN current_summary_list.decision_date IS \'(DC2Type:date_immutable)\'');
        $this->addSql('COMMENT ON COLUMN current_summary_list.accident_start_date IS \'(DC2Type:datetime_immutable)\'');
    }

    public function down(Schema $schema): void
    {
        $this->addSql('DROP TABLE current_summary_list');
    }
}
